...
export default function Hotspot({ state, county, name, _id, lat, lng, address, links, about, tips, birds, hikes, restrooms, roadside, accessible, locationId, parent, childLocations, locationIds, images }: Props) {	
