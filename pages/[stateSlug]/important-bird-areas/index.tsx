			...
			<div className="columns-1 sm:columns-3 mb-12">
				{areas.map(({name, slug}) => (
					<React.Fragment key={slug}>
						<Link href={`/birding-in-${state.slug}/important-bird-areas/${slug}`}>
