...
export default function Home() {
  return (
    <div className="container pb-16 mt-12">
      <Title />
      <PageHeading breadcrumbs={false}>Welcome to Birding Hotspots</PageHeading>
      <h3 className="text-lg mb-4 font-bold">United States</h3>
      <p className="mb-4">
        Links in plain text are to pages in the eBird website. Links in <strong>bold text</strong> are to pages in this
        website with additional information about hotspots.
      </p>
        ...
        {States.map(({ label, slug, code, active }) => (
          <p key={code}>
            {active ? (
              ...
              <a href={`https://ebird.org/region/US-${code}/regions?yr=all&m=`} target="_blank" rel="noreferrer">
                {label}
              </a>
            )}
          </p>
      ...
      <div className="sm:grid grid-cols-2 gap-16">
        <div>
          <p className="mb-4">
            ...
            sightings to eBird. Hotspots provide birders with information about birding locations where birds are being
            seen.
          </p>
          <p className="mb-4">
